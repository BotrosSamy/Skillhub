...
<div class="container">
  ...
  <div id="main" class="col-md-9">
        <form id="exam-submit-from" action="{{ url("exams/submit/$exam->id") }}" method="post">
                @csrf
         </form>
            <!-- blog post -->
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="radio">
                        <label>
                         <input type="radio" name="answers[{{ $quest->id }}]" value="1" form="exam-submit-from" >
                            {{ $quest->option_1 }}
                        </label>
                    </div>
                    <div class="radio">
                        <label>
                            <input type="radio" name="answers[{{ $quest->id }}]"  value="2" form="exam-submit-from">
                            {{$quest->option_2}}
                    </label>
                    </div>
                    <div class="radio">
                        <label>
                            <input type="radio" name="answers[{{ $quest->id }}]"  value="3" form="exam-submit-from">
                            {{$quest->option_3}}
                        </label>
                    </div>
                    <div class="radio">
                        <label>
                            <input type="radio" name="answers[{{ $quest->id }}]"  value="4" form= "exam-submit-from">
                            {{$quest->option_4}}
                        </label>
                    </div>
                </div>
            ...
            <div>
                <button type="submit"  form="exam-submit-from" class="main-button icon-button pull-left">Submit</button>
