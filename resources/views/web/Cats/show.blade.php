    ...
    <div class="row">
                    ...
                    <div class="single-blog">
                        ...
                        <div class="blog-meta">
                            ...
                            <div class="pull-right">
                                <span class="blog-meta-comments"><a href="#"><i class="fa fa-users"></i> {{ $skill->getUser() }}</a></span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="aside" class="col-md-3">
            ...
            <div class="widget category-widget">
                <h3>Categories</h3>
                @foreach($allCat as $CurrCat)
                <a class="category" href="{{url("/categories/show/{$CurrCat->id}")}}">{{$CurrCat->name()}} <span>{{$CurrCat->skills->count()}}</span></a>
                @endforeach
            </div>
            <!-- /category widget -->
        </div>
